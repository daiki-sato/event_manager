    ...
    `
        switch (0) {
          ...
          <form action="/participation_management.php" method="post">
            <div class="flex mt-5">
              <button type='submit' name="status_id" value="1" class="flex-1 bg-blue-500 py-2 mx-3 rounded-3xl text-white text-lg font-bold">参加する</button>
              <button type='submit' name="status_id" value="2" class="flex-1 bg-gray-300 py-2 mx-3 rounded-3xl text-white text-lg font-bold">参加しない</button>
